      ...
      <div className="flex h-full min-h-0 flex-col gap-2 py-1 sm:gap-3 sm:py-2">
        {!hideActionButtons && (
          <div className="flex items-center gap-2">
            <Button
              className={cn(
                "h-10 flex-1 rounded-xl bg-stone-950 text-white hover:bg-stone-800",
                isUserMode && "rounded-2xl bg-slate-950 hover:bg-slate-800",
              )}
            ...
            <Button
              variant="outline"
              className={cn(
                "h-10 rounded-xl border-stone-200 bg-white/85 px-3 text-stone-600 hover:bg-white",
                isUserMode && "rounded-2xl border-slate-200 bg-white text-slate-500",
              )}
